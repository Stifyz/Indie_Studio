...
VictoryState::VictoryState() : ApplicationState("Victory") {
	AudioPlayer::playEffect("win1");

	m_background.init("screen-victory.png", "Victory");
	m_background.set();
	...
	// m_trayManager->createButton(OgreBites::TL_BOTTOM, "continue", "Continue", 200);
...
void VictoryState::buttonHit(OgreBites::Button *button) {
